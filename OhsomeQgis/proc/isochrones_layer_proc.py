...
class ORSisochronesLayerAlgo(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(
                name=self.OUT, description="Isochrones", createByDefault=False
            )
        )
    ...
    def shortHelpString(self):
        ...
        file = os.path.join(HELP_DIR, "algorithm_isochrone_layer.help")
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        params["range_type"] = dimension = DIMENSIONS[
            self.parameterAsEnum(parameters, self.IN_METRIC, context)
        ]
        ...
        id_field_name = self.parameterAsString(
            parameters, self.IN_FIELD, context
        )
        ...
        try:
            ...
            self.isochrones.set_parameters(
                profile, dimension, factor, id_field.type(), id_field_name
            )
