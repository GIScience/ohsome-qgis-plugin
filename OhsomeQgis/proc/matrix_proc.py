...
class ORSmatrixAlgo(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        file = os.path.join(HELP_DIR, "algorithm_matrix.help")
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if source_equals_destination:
            ...
            features_points = (
                sources_features_xformed + destination_features_xformed
            )
        ...
        params.update(
            {
                "locations": [
                    [point.x(), point.y()] for point in features_points
                ],
                "sources": sources_ids,
        ...
        try:
            response = clnt.request(
                "/v2/matrix/" + profile, {}, post_json=params
            )
