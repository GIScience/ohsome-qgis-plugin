...
import pandas as pd
import json
from .utils import find_groupby_names
...
class OhsomeResponse:
        ...
        if isinstance(response, dict):
            ...
            try:
                ...
                raise OhsomeException(
                    message="Invalid JSON response: " + e.msg,
    ...
    def as_dataframe(self):
        ...
        assert not "features" in self.data.keys(), (
            "GeoJSON object cannot be converted to Pandas Dataframe. "
            "Use as_geodataframe() instead."
        )
