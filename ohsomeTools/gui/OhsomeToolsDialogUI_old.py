...
class Ui_OhsomeToolsDialogBase(object):
    def setupUi(self, OhsomeToolsDialogBase):
        ...
        OhsomeToolsDialogBase.resize(388, 669)
        ...
        self.configuration_group_box = QgsCollapsibleGroupBox(OhsomeToolsDialogBase)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/plugins/ohsomeTools/img/icon_help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.ohsome_log_group = QgsCollapsibleGroupBox(OhsomeToolsDialogBase)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ohsome_log_group.sizePolicy().hasHeightForWidth())
        self.ohsome_log_group.setSizePolicy(sizePolicy)
        self.ohsome_log_group.setMinimumSize(QtCore.QSize(0, 0))
        self.ohsome_log_group.setMaximumSize(QtCore.QSize(16777215, 20))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/plugins/ohsomeTools/img/icon_about.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, OhsomeToolsDialogBase):
        ...
        self.centroid_radius_label.setText(_translate("OhsomeToolsDialogBase", "Radius"))
        ...
        self.ohsome_log_group.setTitle(_translate("OhsomeToolsDialogBase", "Log"))
