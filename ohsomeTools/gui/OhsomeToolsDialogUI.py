...
class Ui_OhsomeToolsDialogBase(object):
    def setupUi(self, OhsomeToolsDialogBase):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, -313, 645, 744))
        ...
        self.label_15 = QtWidgets.QLabel(self.general_options_group)
        ...
        self.label = QtWidgets.QLabel(self.general_options_group)
        ...
        self.check_activate_temporal_2 = QtWidgets.QCheckBox(self.frame_6)
        self.check_activate_temporal_2.setChecked(True)
        self.check_activate_temporal_2.setObjectName("check_activate_temporal_2")
        self.horizontalLayout_12.addWidget(self.check_activate_temporal_2)
        self.check_show_metadata_2 = QtWidgets.QCheckBox(self.frame_6)
        self.check_show_metadata_2.setEnabled(True)
        self.check_show_metadata_2.setChecked(False)
        self.check_show_metadata_2.setObjectName("check_show_metadata_2")
        self.horizontalLayout_12.addWidget(self.check_show_metadata_2)
        ...
        self.check_merge_geometries_2 = QtWidgets.QCheckBox(self.frame_8)
        self.check_merge_geometries_2.setEnabled(True)
        self.check_merge_geometries_2.setChecked(True)
        self.check_merge_geometries_2.setObjectName("check_merge_geometries_2")
        self.horizontalLayout_13.addWidget(self.check_merge_geometries_2)
        ...
        self.timeout_label_2 = QtWidgets.QLabel(self.frame_5)
        self.timeout_label_2.setObjectName("timeout_label_2")
        self.horizontalLayout_10.addWidget(self.timeout_label_2)
        self.timeout_input_2 = QtWidgets.QSpinBox(self.frame_5)
        self.timeout_input_2.setAccessibleDescription("")
        self.timeout_input_2.setMinimum(0)
        self.timeout_input_2.setMaximum(9999999)
        self.timeout_input_2.setProperty("value", 0)
        self.timeout_input_2.setObjectName("timeout_input_2")
        self.horizontalLayout_10.addWidget(self.timeout_input_2)
        self.verticalLayout_7.addWidget(self.frame_5)
        self.verticalLayout_5.addWidget(self.general_options_group)
    ...
    def retranslateUi(self, OhsomeToolsDialogBase):
        ...
        self.check_activate_temporal_2.setToolTip(_translate("OhsomeToolsDialogBase", "<html><head/><body><p>Automatically enable the temporal feature for new layers where applicable.</p><p><br/></p><p>This is only applied to responses that contain geometries and in that manner only on those geometry layers it makes sense for.</p></body></html>"))
        self.check_activate_temporal_2.setText(_translate("OhsomeToolsDialogBase", "Qgis temporal feature"))
        self.check_show_metadata_2.setToolTip(_translate("OhsomeToolsDialogBase", "<html><head/><body><p>Include metadata into the query response. Depending on the request of the request this can increase the response data size significantly.</p></body></html>"))
        self.check_show_metadata_2.setText(_translate("OhsomeToolsDialogBase", "Show metadata"))
        self.check_merge_geometries_2.setToolTip(_translate("OhsomeToolsDialogBase", "<html><head/><body><p>Check this to <span style=\" text-decoration: underline;\">automatically merge compatible geometry types</span>. </p><p><span style=\" text-decoration: underline;\">It is recommended to keep this checked.</span></p><p>The benefit is that the amount of written layers will be massively reduced.</p><p>The reason is that results may contain single and multi-geometries at once (Polygon, MultiPolygon etc.) and without combining them one layer per geometry type will be written, resulting in an increased number of layers. </p><p><br/></p></body></html>"))
        self.check_merge_geometries_2.setText(_translate("OhsomeToolsDialogBase", "Harmonize geometries"))
        self.timeout_label_2.setToolTip(_translate("OhsomeToolsDialogBase", "<html><head/><body><p>Apply a request <span style=\" text-decoration: underline;\">timeout in seconds</span> after that the ohsome API should terminate the request.</p><p>For the public ohsome API instance the maximum value is 100. For private instances there is no maximum.</p></body></html>"))
        self.timeout_label_2.setText(_translate("OhsomeToolsDialogBase", "Timeout"))
        self.timeout_input_2.setToolTip(_translate("OhsomeToolsDialogBase", "<html><head/><body><p>Apply a request <span style=\" text-decoration: underline;\">timeout in seconds</span> after that the ohsome API should terminate the request. If the value 0 is set (default), the server side timeout is used automatically, which can be up to 600 seconds.</p><p>Depending on the size of the query, too low entries will yield API errors.</p><p>This setting is only used for the public ohsome API and not for private ones.</p></body></html>"))
