...
class Ui_OhsomeToolsDialogBase(object):
    def setupUi(self, OhsomeToolsDialogBase):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 645, 720))
        ...
        self.verticalLayout_10.addLayout(self.gridLayout_19)
        ...
        self.check_keep_geometryless = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_4)
        ...
        self.verticalLayout_5.addWidget(self.check_keep_geometryless)
