...
class Ui_OhsomeToolsDialogBase(object):
    def setupUi(self, OhsomeToolsDialogBase):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, -567, 645, 998))
        ...
        self.label_output = QtWidgets.QLabel(self.centroid_tab)
        self.label_output.setObjectName("label_output")
        self.horizontalLayout_2.addWidget(self.label_output)
        self.lineEdit_output = QtWidgets.QLineEdit(self.centroid_tab)
        self.lineEdit_output.setObjectName("lineEdit_output")
        self.horizontalLayout_2.addWidget(self.lineEdit_output)
        self.pushButton_output = QtWidgets.QPushButton(self.centroid_tab)
