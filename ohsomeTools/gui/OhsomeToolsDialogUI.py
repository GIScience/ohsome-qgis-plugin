...
class Ui_OhsomeToolsDialogBase(object):
    def setupUi(self, OhsomeToolsDialogBase):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, -608, 623, 976))
        ...
        self.general_options_group = QgsCollapsibleGroupBox(self.centroid_tab)
        ...
        self.gridLayout_8.addWidget(self.general_options_group, 1, 0, 1, 1)
    ...
    def retranslateUi(self, OhsomeToolsDialogBase):
        ...
        self.check_merge_geometries.setText(_translate("OhsomeToolsDialogBase", "Harmonize geometries in Outpüut"))
