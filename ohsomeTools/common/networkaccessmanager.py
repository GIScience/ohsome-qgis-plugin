...
class NetworkAccessManager(object):
    ...
    def replyFinished(self):
        ...
        if err != QNetworkReply.NoError:
            ...
            if err == QNetworkReply.TimeoutError:
                ...
                self.http_call_result.exception = (
                    RequestsExceptionConnectionError(msg)
                )
                ...
                if self.on_abort:
                    self.http_call_result.exception = (
                        RequestsExceptionUserAbort(msg)
                    )
                else:
            ...
            if (
                redirectionUrl is not None
                and redirectionUrl != self.reply.url()
            ):
        ...
        # print('networkaccessmanager done')
