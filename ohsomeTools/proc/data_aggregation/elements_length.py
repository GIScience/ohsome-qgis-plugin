...
class ElementsLength(QgsProcessingAlgorithm):
    """
    ...
    parameters = [i for i in AGGREGATION_SPECS['elements/length']]
    ...
    def name(self):
        ...
        """
        return 'dataaggregationelementslength'
    ...
    def displayName(self):
        ...
        """
        return self.tr('Elements Length')
