...
class ElementsArea(QgsProcessingAlgorithm):
    """
    ...
    parameters = [i for i in AGGREGATION_SPECS['elements/area']]
    ...
    def name(self):
        ...
        """
        return 'dataaggregationelementsarea'
