...
class UsersCount(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        """
        return self.tr(
            """<p>Users Count endpoint for the <strong>Ohsome-API</strong>. See <a href="https://docs.ohsome.org/ohsome-api/v1/">documentation</a>. </p>
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if self.parameterAsBool(parameters, self.PARAMETER, context):
            density = "/density"
        else:
            density = ""
